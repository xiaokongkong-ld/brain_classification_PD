...
def get_data(dataset = "Training", feature = False):
    ...
    if dataset == "Training" and feature == False:
        for i in range(1,11):
            healthy.append([np.genfromtxt('./data/'+dataset+'/Health/sub'+str(i)+'/common_fiber_matrix.txt'), 1])
            patient.append([np.genfromtxt('./data/'+dataset+'/Patient/sub'+str(i)+'/common_fiber_matrix.txt'), 0])
        ...
        for i in range(1,11):
            healthy.append([np.genfromtxt('./data/'+dataset+'/Health/sub'+str(i)+'/pcc_fmri_feature_matrix_0.txt'), 1])
            patient.append([np.genfromtxt('./data/'+dataset+'/Patient/sub'+str(i)+'/pcc_fmri_feature_matrix_0.txt'), 0])
